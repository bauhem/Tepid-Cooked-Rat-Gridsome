<template>
  <div class="home-container">
    <div class="home-container1 container">
          ...
          <div class="home-nav1">
            <div class="home-container2">
              <img
                ...
                class="home-image1"
              />
              <div data-type="CloseMobileMenu" class="home-menu-close">
          ...
          <span class="home-text1">
            <span>
              <span>
                ...
                volutpat turpis.
                <span v-html="rawutov"></span>
              </span>
              <span><span v-html="rawhtrb"></span></span>
            </span>
            <span>
              <span>
                Mauris luctus rutrum mi ut rhoncus. Integer in dignissim tortor.
                <span v-html="raw7zk5"></span>
              </span>
              <span><span v-html="rawz5ac"></span></span>
            </span>
          </span>
...
export default {
  ...
  metaInfo: {
    title: 'Tepid Cooked Rat',
    meta: [
      {
        property: 'og:title',
        content: 'Tepid Cooked Rat',
      },
    ],
  },
}
